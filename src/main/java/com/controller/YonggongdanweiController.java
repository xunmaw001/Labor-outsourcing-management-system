...
public class YonggongdanweiController {
    ...
    public R update(@RequestBody YonggongdanweiEntity yonggongdanwei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yonggongdanwei);
        yonggongdanweiService.updateById(yonggongdanwei);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YonggongdanweiEntity> wrapper = new EntityWrapper<YonggongdanweiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yonggongdanweiService.selectCount(wrapper);
