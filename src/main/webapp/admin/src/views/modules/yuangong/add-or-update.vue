<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.gerenxiangpian" label="个人相片" prop="gerenxiangpian">
          <file-upload
          tip="点击上传个人相片"
          action="file/upload"
          :limit="3"
          ...
          @change="gerenxiangpianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.gerenxiangpian" label="个人相片" prop="gerenxiangpian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gerenxiangpian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxishouji = true;
          ...
          if(o=='gerenxiangpian'){
            this.ruleForm.gerenxiangpian = obj[o];
	    this.ro.gerenxiangpian = true;
            continue;
          }
        }
      }
    ...
    gerenxiangpianUploadChange(fileUrls) {
