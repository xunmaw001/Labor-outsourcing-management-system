<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招聘公司" prop="zhaopingongsi">
          <el-input v-model="ruleForm.zhaopingongsi" 
              placeholder="招聘公司" clearable  :readonly="ro.zhaopingongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招聘公司" prop="zhaopingongsi">
              <el-input v-model="ruleForm.zhaopingongsi" 
                placeholder="招聘公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招聘职位" prop="zhaopinzhiwei">
          <el-input v-model="ruleForm.zhaopinzhiwei" 
              placeholder="招聘职位" clearable  :readonly="ro.zhaopinzhiwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招聘职位" prop="zhaopinzhiwei">
              <el-input v-model="ruleForm.zhaopinzhiwei" 
                placeholder="招聘职位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="职位介绍" prop="zhiweijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="职位介绍"
                  v-model="ruleForm.zhiweijieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhiweijieshao" label="职位介绍" prop="zhiweijieshao">
                    <span>{{ruleForm.zhiweijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhaopingongsi'){
            this.ruleForm.zhaopingongsi = obj[o];
	    this.ro.zhaopingongsi = true;
            continue;
          }
          if(o=='zhaopinzhiwei'){
	    ...
	    this.ro.zhaopinrenshu = true;
          ...
          if(o=='zhiweijieshao'){
            this.ruleForm.zhiweijieshao = obj[o];
	    this.ro.zhiweijieshao = true;
            continue;
          }
          if(o=='lianxifangshi'){
