    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '招聘公司' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.zhaopingongsi" placeholder="招聘公司" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.zhaopingongsi" placeholder="招聘公司" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.zhaopingongsi" placeholder="招聘公司" clearable></el-input>
                </el-form-item>
          <el-form-item>
...
export default {
  ...
  methods: {
    ...
    chartDialog() {
      ...
      this.$nextTick(()=>{
        // zhaopinzhiwei zhaopinzhiwei
        //  zhaopinrenshu
        // xcolumn ycolumn zhaopinzhiwei zhaopinrenshu
        var zhaopinrenshuChart = this.$echarts.init(document.getElementById("zhaopinrenshuChart"),'macarons');
        this.$http({
            url: `value/zhaopinxinxi/zhaopinzhiwei/zhaopinrenshu`,
            method: "get"
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    xAxis.push(res[i].zhaopinzhiwei);
                    yAxis.push(res[i].total);
                    pArray.push({
                    value: res[i].total,
                    name: res[i].zhaopinzhiwei
                    })
                    var option = {};
                    option = {
                            title: {
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.zhaopingongsi!='' && this.searchForm.zhaopingongsi!=undefined){
            params['zhaopingongsi'] = '%' + this.searchForm.zhaopingongsi + '%'
          }
      this.$http({
