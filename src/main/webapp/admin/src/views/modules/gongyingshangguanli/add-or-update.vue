<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工薪酬" prop="yuangongxinchou">
          <el-input v-model="ruleForm.yuangongxinchou" 
              placeholder="员工薪酬" clearable  :readonly="ro.yuangongxinchou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工薪酬" prop="yuangongxinchou">
              <el-input v-model="ruleForm.yuangongxinchou" 
                placeholder="员工薪酬" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhaopinshijian" label="招聘时间" prop="zhaopinshijian">
              <el-input v-model="ruleForm.zhaopinshijian" 
                placeholder="招聘时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongrenshu = true;
          ...
          if(o=='yuangongxinchou'){
            this.ruleForm.yuangongxinchou = obj[o];
	    this.ro.yuangongxinchou = true;
            continue;
          }
          if(o=='zhaopingangwei'){
    ...
    info(id) {
      this.$http({
        url: `gongyingshangguanli/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gongyingshangguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gongyingshangguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
