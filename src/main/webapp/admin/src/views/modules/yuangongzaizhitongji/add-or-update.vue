    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="在职状态" prop="zaizhizhuangtai">
          <el-select v-model="ruleForm.zaizhizhuangtai" placeholder="请选择在职状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="在职状态" prop="zaizhizhuangtai">
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zaizhizhuangtaiOptions = "在职,离职".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `yuangongzaizhitongji/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yuangongzaizhitongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuangongzaizhitongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
