<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="派遣公司" prop="paiqiangongsi">
          <el-input v-model="ruleForm.paiqiangongsi" 
              placeholder="派遣公司" clearable  :readonly="ro.paiqiangongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="派遣公司" prop="paiqiangongsi">
              <el-input v-model="ruleForm.paiqiangongsi" 
                placeholder="派遣公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="派遣时间" prop="paiqianshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.paiqianshijian" 
                type="datetime"
                placeholder="派遣时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.paiqianshijian" label="派遣时间" prop="paiqianshijian">
              <el-input v-model="ruleForm.paiqianshijian" 
                placeholder="派遣时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongsi = true;
          ...
          if(o=='paiqiangongsi'){
            this.ruleForm.paiqiangongsi = obj[o];
	    this.ro.paiqiangongsi = true;
            continue;
          }
          if(o=='paiqianshijian'){
            this.ruleForm.paiqianshijian = obj[o];
	    this.ro.paiqianshijian = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `paiqianyuangong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.paiqianyuangongCrossAddOrUpdateFlag = false;
                  this.parent.search();
