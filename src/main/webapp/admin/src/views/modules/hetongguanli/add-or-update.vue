<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合同有效期" prop="hetongyouxiaoqi">
          <el-input v-model="ruleForm.hetongyouxiaoqi" 
              placeholder="合同有效期" clearable  :readonly="ro.hetongyouxiaoqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合同有效期" prop="hetongyouxiaoqi">
              <el-input v-model="ruleForm.hetongyouxiaoqi" 
                placeholder="合同有效期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiandingshijian = true;
          ...
          if(o=='hetongyouxiaoqi'){
            this.ruleForm.hetongyouxiaoqi = obj[o];
	    this.ro.hetongyouxiaoqi = true;
            continue;
          }
          if(o=='daoqiriqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `hetongguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.hetongguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
